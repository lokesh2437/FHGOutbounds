...
public class DBUtility {
	...
	private static Connection conn=null;
		...
		try {
			...
			conn=DriverManager.getConnection("jdbc:oracle:thin:@"+properties.getProperty("host")+":"+properties.getProperty("port")+":"+properties.getProperty("sid"),properties.getProperty("user"),properties.getProperty("pass"));
