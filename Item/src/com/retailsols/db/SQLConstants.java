...
public class SQLConstants {
	...
	public static String getItemHeader="SELECT ID,TYPE,'3:'||POSDEPARTMENTID AS POSDEPARTMENTID,ITEMCOST,UOMCODE,DISCOUNTABLE,DAMAGEDISCOUNTABLE,SERIALIZEDITEM,IMAGEFILENAME,IMAGELOCATION,SHORT_DESCRIPTION,LONG_DESCRIPTION,'5:'||SUB_CLASS_ID AS SUB_CLASS_ID FROM XXFHG_POS_ITEM HD WHERE TRANSFERRED_POS='-1'";
	...
	public static String getMessages="SELECT ID_MSG,NA_MSG_DPLY FROM XXFHG_POS_MSG_REF WHERE TRANSFER_POS='-1'";
	public static String getImageName="SELECT ITEM FROM XXFHG_POS_IMG WHERE ID=?";
	...
	public static String updateMessages="UPDATE XXFHG_POS_MSG_REF SET TRANSFER_POS='1'";
	...
	public static String checkNewMesgs="SELECT COUNT(*) FROM XXFHG_POS_MSG_REF WHERE TRANSFER_POS='-1'";
}
